package com.example.contactapppam6;
...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(v-> {
            if (etName.getText().toString().equals("") || etNumber.getText().toString().equals("") || etInstagram.getText().toString().equals("") || etGroup.getText().toString().equals("")){
        ...
        contactList.add(new ContactModel("Jusuf Latifah", "+62878555504", "business","bayerhilarious"));
        contactList.add(new ContactModel("Burhanuddin Taufik", "+62878555501", "family","integersjunior"));
        contactList.add(new ContactModel("Latifah Bagus", "+62878555502", "study","clearcarbon"));
        contactList.add(new ContactModel("Agung Nurul", "+62878555503", "family","opticalwwf"));
        contactList.add(new ContactModel("Cahaya Krisna", "+628785555044", "business","gisremedy"));
